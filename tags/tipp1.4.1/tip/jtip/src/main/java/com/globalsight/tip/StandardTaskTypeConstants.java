...
public class StandardTaskTypeConstants {
	public static final String TRANSLATE_STRICT_BITEXT_URI = 
    ...
    public static final String TRANSLATE_GENERIC_BITEXT_URI = 
    ...
    public static final String TRANSLATE_NATIVE_FORMAT_URI = 
    ...
    public static final String PREPARE_SPECIFICATIONS_URI = 
